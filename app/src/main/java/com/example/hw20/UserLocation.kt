...
const val GEOFENCE_RADIUS2 = 200
const val GEOFENCE_ID2 = "REMINDER_GEOFENCE_ID"
const val GEOFENCE_EXPIRATION2 = 10 * 24 * 60 * 60 * 1000 // 10 days
const val GEOFENCE_DWELL_DELAY2 =  10 * 1000 // 10 secs // 2 minutes
const val GEOFENCE_LOCATION_REQUEST_CODE2 = 12345
const val CAMERA_ZOOM_LEVEL2 = 13f
const val LOCATION_REQUEST_CODE2 = 123
private val TAG: String = UserLocation::class.java.simpleName
...
class UserLocation : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun setLongClick(map: GoogleMap) {
        map.setOnMapLongClickListener { latlng ->
            ...
            if (key != null) {
                val user = User(key, latlng.latitude, latlng.longitude)
            ...
            fusedLocationClient.setMockLocation(newLocation)
